...
const updateDescription = (id) => {
    ...
    switch (id) {
        ...
        case "openAi":
            ...
            break;
        case "ElevenLabs":
            description = "ElevenLabs: ElevenLabs is a platform that allows you to clone voices using artificial intelligence. The platform uses a deep learning model to train a voice clone that sounds almost exactly like the original voice.";
            break;
        case "huggingFace":
